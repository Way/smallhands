...
export const D: Record<string, [string, string]> = {
  ...
  'tool.ramp.desc': [
    'Build a diagonal ramp to climb a layer — drag up or down from solid ground. Loaded smallies can walk it (unlike ladders).',
    'Baue eine diagonale Rampe eine Ebene hinauf — von festem Boden aus nach oben oder unten ziehen. Beladene Smallies können sie begehen (anders als Leitern).',
  ],
